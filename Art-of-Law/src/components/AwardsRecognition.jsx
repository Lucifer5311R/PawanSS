...
function AwardsRecognition() {
  ...
  const awardsData = [
    ...
    },
    {
      ...
      randomInfo: 'Project Nyayam received this recognition for its contributions to promoting justice and the rule of law. More details about the specific achievement will be available soon.',
    },
    {
      id: 5,
      title: 'Baazigar Recognition',
      detail: 'Awarded for outstanding achievement under the “Baazigar” title.',
      randomInfo: 'The "Baazigar" recognition likely celebrates a remarkable achievement in a competitive event. Details about the criteria and the context are forthcoming.',
    },
    {
      id: 4,
    ...
    },
    {
      ...
      randomInfo: 'This award honors exceptional dedication to serving the community through volunteer work and impactful initiatives. More information about the specific service recognized will be provided.',
    },
    {
      id: 3,
